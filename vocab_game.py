...
# 📌 [จุดที่ 2] เพิ่มการเคลียร์ค่า st.session_state.ans3_val และ st.session_state.ans4_val เมื่อกดปุ่มใหม่
def reset_game():
...
def show_result_dialog(ans1, ans2, ans3, ans4):
    ...
    # 📌 [จุดที่ 4] เพิ่มการตรวจข้อ 3 และ ตรวจข้อ 4
    if u_ans3 == "dog":
    ...
    # 📌 [จุดที่ 5] เพิ่มการเช็คคะแนน score == 4
    if score == 4:
        st.success("🎉 You win!")
    else:
        st.error("💀 You lose!")
...
# 📌 [จุดที่ 8] เพิ่มการส่ง ans3, ans4 เข้าไปแสดงผลใน Dialog
if st.session_state.get("is_ended", False):
    show_result_dialog(ans1, ans2, ans3, ans4)

st.divider()
st.write("นางสาว พัทธ์ธ๊ณษณัท สิทธฺวิรยะกุล เลขที่ 28 ม.4/3")
